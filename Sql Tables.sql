...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `commenterUsername` 	varchar(50) 			NOT NULL 		COMMENT 'Username of Commenter',
  `_comment` 				varchar(1000) 		NOT NULL 		COMMENT 'User Comment',
   `report` 						int(11) 					DEFAULT 0 	COMMENT 'If 1 then comment is reported',
